...
export const schedules: Schedule[] = [
  ...
  { id: 's105', day: 1, time: '21:00', title: '저녁집회 (찬양 + 말씀)', location: '대예배실', speaker: '박찬희 목사', category: 'worship', notes: '찬양 인도: 성결대 주사랑 음악선교단' },
  ...
  { id: 's203', day: 2, time: '09:30', title: '특강 1: AI와 나는 누구인가?', location: '대예배실', speaker: '최윤식 박사', category: 'worship' },
  ...
  { id: 's210', day: 2, time: '20:00', title: '저녁집회: 하나님이 부여하신 정체성', location: '대예배실', speaker: '박찬희 목사', category: 'worship', notes: '찬양 인도: 성결대 주사랑 음악선교단' },
