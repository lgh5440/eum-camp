...
export default function DataManager() {
  ...
  return (
    <div className="space-y-5 max-w-3xl">
      ...
      {/* 페이지 제목 */}
      <div>
        <h2 className="text-lg font-bold text-white mb-0.5">데이터 관리</h2>
        <p className="text-xs text-slate-400">
      ...
      <section className="rounded-2xl p-5" style={CARD}>
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-bold text-white">변경 내역</h3>
        ...
        <section className="rounded-2xl p-5" style={{ ...CARD, borderColor: 'rgba(14,165,233,0.3)' }}>
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-white">참가비 일괄 처리 (가등록 2만원)</h3>
      ...
      <section className="rounded-2xl p-5" style={CARD}>
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            <h3 className="text-sm font-bold text-white">백업 파일 다운로드</h3>
      ...
      <section className="rounded-2xl p-5" style={CARD}>
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            <h3 className="text-sm font-bold text-white">백업 복원</h3>
