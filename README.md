<!-- as-of: 2026-09-04 @ b5f232c127d306abbbbafe70e9602ad5a5c7f014 -->
...
👉 **[데모 사이트 바로가기](https://eum-camp-template.web.app)**

- 가상 50명(학생 25 + 교사 8 + 진행팀 17) 데이터 미리 채워둠
- 참가자 명단·교회별 신청·조 편성·방 배정·체크인·일정 등 **실제 운영 화면 그대로** 둘러보기 가능
- 데이터는 모두 가상이라 자유롭게 수정해봐도 OK
...
**Claude Code** 또는 **OpenAI Codex** 데스크탑 앱(둘 다 2026-04 출시) 하나만 깔면 끝 — VS Code 같은 다른 에디터 불필요.
명령어·환경변수·Firebase Console 클릭을 전부 AI가 한국어로 대신 안내합니다.

👉 **[AI 설치 가이드 (비기술자용, 2026-05 기준 최신)](./docs/AI_SETUP_GUIDE.md)**

> 💸 비용: Claude Pro $20/월 또는 ChatGPT Plus $20/월 1회 결제로 설치 + 다른 교회 추가 셋업까지 가능. 이미 둘 중 하나 구독 중이면 추가 비용 0원. 시스템 자체 운영은 영구 무료(Firebase Spark).
